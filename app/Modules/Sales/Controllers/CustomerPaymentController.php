...
class CustomerPaymentController extends Controller
{
    ...
    {
        $q = CustomerPayment::with(['customer:id,name,code', 'creator:id,name'])
    ...
    // ── Store a payment (cross-customer convenience endpoint) ─────────────
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $payment->load('customer:id,name,code', 'creator:id,name');

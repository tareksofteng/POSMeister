...
class CashbookController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        // Topbar workspace scope takes precedence — admin browsing Dhaka
        // workspace must NOT see Chattogram cashbooks. An explicit
        // ?branch_id= still narrows further (e.g. report drill-down).
